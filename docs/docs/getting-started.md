...
> [!WARNING]
> Если логирование включено, но вы не установите адаптер для логгирования, это привдет к исключению `LoggingConfiguration configuration must be set up when logging is enabled.`.
